...
class paytmOrderController extends Controller
{
    ...
    public function handlePaytmRequest( $order_id, $amount ) {
        ...
        $paramList["MID"] = 'lZwymD65390597915459';
        ...
        $paytm_merchant_key = '2yJNrZUGEU2#PcPD';
    ...
    function getConfigPaytmSettings() {
        ...
        define('PAYTM_MERCHANT_KEY', '2yJNrZUGEU2#PcPD'); //Change this constant's value with Merchant key downloaded from portal
        define('PAYTM_MERCHANT_MID', 'lZwymD65390597915459'); //Change this constant's value with MID (Merchant ID) received from Paytm
    ...
    public function paytmCallback( Request $request ) {
        ...
        // Load all functions of encdec_paytm.php and config-paytm.php
        PaytmOrderController::getAllEncdecFunc();
        PaytmOrderController::getConfigPaytmSettings();

        // Verifing Checksum
        $isValidChecksum = verifychecksum_e(
            $parameters, 
            '2yJNrZUGEU2#PcPD',  
            $request->CHECKSUMHASH
        );

        // Checksum verification Failed 
        if($isValidChecksum == "FALSE") {   
          return 'Your CHECKSUMHASH did not match did you hack the site';
      }
...
//start
    $orderId = $order_id;
    $merchantMid = "lZwymD65390597915459";
    $merchantKey = "2yJNrZUGEU2#PcPD";
      ...
      if($responseData['STATUS'] !=='TXN_SUCCESS')
 {
    ...
    //end
        ...
        $order->save();
        return view( 'paytm.order-complete');
